 ...
 <c:import url="/front/top.jsp"></c:import>
   ...
   <div id="main_content">     
    <div class="crumb_navigation">
  	  你在: <span class="current">用户注册</span>
    </div>        
   	...
   	<div class="center_title_bar">用户注册</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
               ...
               <form name="form" action="<%=path%>/servlet/UserServlet?method=add" method="post" onSubmit="return checkdata()">      
                    <div class="form_row">
                    <label class="contact"><strong>用户名:</strong></label>
                    <input name="username" class="contact_input" />
                    </div>  
                    ...
                    <div class="form_row">
                    <label class="contact"><strong>密码确认:</strong></label>
                    <input name="pwd2" type="password" class="contact_input" />
                    </div>
                    
                    <div class="form_row">
                    <label class="contact"><strong>真实姓名:</strong></label>
                    <input name="realName" class="contact_input" />
                    </div>
                    ...
                    <INPUT name="birthday" onfocus=calendar() readOnly size="20" maxlength="20"  class="contact_input"/>
                    </div>
                    
                    <div class="form_row">
                    <label class="contact"><strong>电子邮箱:</strong></label>
                    <input type="text" name="email" size="20"  class="contact_input" />
                    </div>
                    
                    <div class="form_row">
                    <label class="contact"><strong>手机号码:</strong></label>
                    <input type="text"  name="phoneNumber" size="20" maxlength="20" class="contact_input" />
                    </div>
                    
                    <div class="form_row">
                    <label class="contact"><strong>地址:</strong></label>
                    <input type="text" class="contact_input" name="address" size="20" maxlength="100"/>
                    </div>
                    
                   	<div class="form_row">
                    <label class="contact"><strong>邮编:</strong></label>
                    <input type="text" class="contact_input" name="postCode" size="6" maxlength="6"/>
                    </div>
                    <div class="form_row">
