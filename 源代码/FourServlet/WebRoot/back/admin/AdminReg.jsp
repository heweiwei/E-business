...
<html>
	<head>
		...
		<script language=JavaScript src="/FourServlet/back/admin/js/regcheckdata.js"></script> 
		<script language=javascript src="/FourServlet/back/admin/js/calendar.js"></script>
	</head>
	...
	<body>
	<form name="form" action="/FourServlet/servlet/AdminServlet?method=add" method="post" onSubmit="return checkdata()">
