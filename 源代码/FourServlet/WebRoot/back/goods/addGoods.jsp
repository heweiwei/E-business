...
<SCRIPT language=javascript>
	...
	<form action="<%=path%>/servlet/GoodsServlet?method=add" method="post" enctype="multipart/form-data" name="frm" onsubmit="return checkdata();">
		<table class="table" cellspacing="1" cellpadding="2" width="99%"
			...
			<tbody>
				...
				<tr>
					...
					<td class="td_bg">
						<textarea rows="5" cols="40" name="describ"></textarea>
					</td>
				</tr>
				<tr>
					<td class="td_bg" height="23">
