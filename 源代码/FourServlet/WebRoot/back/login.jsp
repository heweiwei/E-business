...
<table width="681" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:120px">
  <tr>
    ...
    <table width="190" height="106" border="0" align="center" cellpadding="2" cellspacing="0">
      ...
      <form action="<%=path%>/servlet/LoginServlet?method=back" method="post">
            <tr>
              <td height="50" colspan="2" align="left">&nbsp;</td>
            </tr>
            
            <tr>
              <td width="60" height="30" align="left">µÇÂ½Ãû³Æ</td>
              <td><input name="username" value="${inputNameBack }" type="TEXT" style="background:url(Images/login_6.gif) repeat-x; border:solid 1px #27B3FE; height:20px; background-color:#FFFFFF" id="UserName"size="14"></td>
            </tr>
            
            <tr>
              <td height="30" align="left">µÇÂ½ÃÜÂë</td>
            ...
            <tr>
              <td height="30"> Ñé Ö¤ Âë </td>
			  <td><input name="rand" type="text" id="Code" size="4" style="background:url(Images/login_6.gif) repeat-x; border:solid 1px #27B3FE; height:20px; background-color:#FFFFFF" maxlength="4">
			  <img src="<%=path%>/back/img.jsp" width="50" height="24" />
		      </td>
            </tr>
            
	          <tr>
	              <td height="40" colspan="2" align="center"><img src="Images/tip.gif" width="16" height="16"> <a href="#">·µ»ØÊ×Ò³</a></td>
	          <tr>
	          
              <td colspan="2" align="center"><input type="submit" name="submit" style="background:url(Images/login_5.gif) no-repeat" value=" µÇ  Â½ "> 
			  <input type="reset" name="Submit" style="background:url(Images/login_5.gif) no-repeat" value=" È¡  Ïû ">
			  </td>
