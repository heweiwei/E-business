...
public class PageDAO {
	public static final String Text = "text"; //文字分页

	public static final String Image = "image";//图片分页

	public static final String BbsText = "bbstext";//论坛格式分页

	public static final String BbsImage = "bbsimage";//论坛图片格式分页
